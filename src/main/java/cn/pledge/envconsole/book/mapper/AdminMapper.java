...
public interface AdminMapper {
    ...
    List<Admin> employeeAdminList(@Param("page") int page,
                                  @Param("size") int size,
                                  @Param("userAddress") String userAddress,
                                  @Param("remark") String remark, @Param("parentId") Integer parentId);

    Integer employeeAdminTotal(@Param("userAddress") String userAddress,
                               @Param("remark") String remark, @Param("parentId") Integer parentId);
